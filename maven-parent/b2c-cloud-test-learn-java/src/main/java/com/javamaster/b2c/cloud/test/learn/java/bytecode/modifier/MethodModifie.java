package com.javamaster.b2c.cloud.test.learn.java.bytecode.modifier;
...
public enum MethodModifie {
     ...
     * @return
     */
    public static List<MethodModifie> getModifiers(short accessFlags) {
        List<MethodModifie> methodModifiers = Lists.newArrayList();
        for (MethodModifie modifier : MethodModifie.values()) {
